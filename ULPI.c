...
struct groupinfo groupinfo[] = {
	GROUP("DATA", GROUP_TYPE_INPUT, 8, 0, 16, NULL),
	GROUP("CTRL", GROUP_TYPE_INPUT, 4, 0, 16, NULL),
	GROUP("PID", GROUP_TYPE_FAKE_GROUP, 2, 4, 16, "PID.tsf"),
	GROUP("ADDR", GROUP_TYPE_FAKE_GROUP, 3, 7, 10, NULL),
	GROUP("EP", GROUP_TYPE_FAKE_GROUP, 2, 4, 10, NULL),
	GROUP("DATA size", GROUP_TYPE_FAKE_GROUP, 4, 32, 10, NULL),
	GROUP("Decoded cycle", GROUP_TYPE_MNEMONIC, SEQUENCE_TEXT_WIDTH, SEQUENCE_TEXT_WIDTH, 0, NULL)
};
